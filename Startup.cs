...
namespace ExemploApiCatalogoJogos
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          //  services.AddSingleton<IExemploSingleton, ExemploCicloDeVida>(); // falta add curso n mostra como
            services.AddScoped<IExemploScoped, ExemploCicloDeVida>();
           // services.AddTransient<IExemploTransient, ExemploCicloDeVida>();  // falta add curso n mostra como
